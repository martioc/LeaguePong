...
public class UsuarioController {
	...
	public List<Usuario> getUsuario(@PathVariable int id) {
		...
		String QUERY;
		QUERY = "select ID_USUARIO, NOMBRE_USUARIO, PASSWORD, MAIL, LOCALIDAD,  NIVEL from usuarios where id_usuario = "
				+ id;
	...
	public List<Usuario> getUserId(@PathVariable String username,@PathVariable String password) {
		...
		QUERY = "select ID_USUARIO from usuarios where NOMBRE_USUARIO = \"" + username
